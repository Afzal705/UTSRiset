    import { Particle } from './particle.js'; // Pastikan jalur file ini benar
    ...
    class PSO {
        constructor(n_Particles, n_Dimensi, obj_Function) {
            ...
            this.gbestFitness = -Infinity;  // Inisialisasi yang benar untuk masalah maksimisasi
            this.gbestPosition = [];
        ...
        init_particles() {
            for (let i = 0; i < this.n_Particles; i++) {
                ...
                particle.inisialisasiPosisi(0, 10);  // Tentukan rentang posisi partikel
        ...
        updateGbest() {
            this.particles.forEach((particle) => {
                if (particle.pbestFitness > this.gbestFitness) {  // Bandingkan untuk fitness terbaik
